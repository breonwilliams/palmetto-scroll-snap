<?php
/**
 * Palmetto Scroll Snap - Content Only Template
 * This template provides just the scroll snap content to be inserted into the page
 */
...
<style>
    /* Kill smooth scroll for our sections */
    ...
    .pss-scroll-container {
        position: relative;
        width: 100%;
        /* Remove fixed height to allow footer to show */
        /* height: 100vh; */
        overflow-y: visible;
        overflow-x: hidden;
        /* Disable scroll snap to allow natural page scroll with footer */
        /* scroll-snap-type: y mandatory; */
        -webkit-overflow-scrolling: touch;
    }
    
    /* Alternative: Use viewport sections without container scroll */
    body.pss-scroll-active {
        scroll-snap-type: y mandatory;
    }
...
(function() {
    ...
    function initScrollSnap() {
        ...
        console.log('[PSS] Palmetto Scroll Snap initialized');
    }
