<?php
/**
 * Palmetto Wildlife Extractors - Breakdance Template
 * This template is specifically designed for Breakdance sites
 */
...
// Since Breakdance handles its own template structure, we need to work within it
get_header();
?>
...
(function() {
    ...
    // Override Lenis constructor to prevent recreation
    window.Lenis = function() {
        console.log('[PSS] Lenis creation blocked');
        return {
            start: function() {},
            stop: function() {},
            destroy: function() {},
...
<!-- Scroll Snap Styles -->
<style>
    /* Override Breakdance smooth scroll */
    html, body {
...
</div><!-- .pss-main-content -->

<script>
document.addEventListener('DOMContentLoaded', function() {
    // Kill Lenis again if it was recreated
    if (window.EhGlobalLenisInstance) {
        try {
            window.EhGlobalLenisInstance.stop();
            window.EhGlobalLenisInstance.destroy();
    ...
    if (!wrapper || !sections.length) {
        console.log('[PSS] Required elements not found');
        return;
    }
    ...
    console.log('[PSS] Palmetto Scroll Snap initialized successfully');
});
</script>

<?php 
// Load Breakdance footer
get_footer(); 
?>